# TODO: Translation updated at 2026-04-30 02:30
translate russian strings:
    # renpy/common/000statements.rpy:28
    old "Click to play the video."
    new "Нажмите, чтобы воспроизвести видео."
    # renpy/common/00accessibility.rpy:28
    old "Self-voicing disabled."
    new "Самоозвучивание отключено."
    # renpy/common/00accessibility.rpy:29
    old "Clipboard voicing enabled. "
    new "Озвучивание через буфер обмена включено. "
    ...
    new "Понижение громкости при самоозвучивании"
    # renpy/common/00accessibility.rpy:180
    old "Mono Audio"
    new "Монофонический звук"
    ...
    new "Меню доступности. Используйте стрелки вверх и вниз для навигации, а Enter — для активации кнопок и ползунков."
    # renpy/common/00accessibility.rpy:288
    old "Self-Voicing and Audio"
    new "Самоозвучивание и звук"
    ...
    new "Опции в этом меню предназначены для улучшения доступности. Они могут работать не во всех играх, а некоторые комбинации настроек могут сделать игру неиграбельной. Это не проблема игры или движка. Для лучших результатов при смене шрифтов старайтесь сохранять размер текста таким же, каким он был изначально."
    ...
    new "Интерактивный директор здесь не включён."
    ...
    new "ЛКМ — переключить атрибут, ПКМ — переключить отрицательный атрибут."
    # renpy/common/00director.rpy:1765
    old "Transforms:"
    new "Трансформы:"
    # renpy/common/00director.rpy:1776
    old "Click to set transform, right click to add to transform list."
    new "ЛКМ — установить трансформ, ПКМ — добавить в список трансформов."
    # renpy/common/00director.rpy:1777
    old "Customize director.transforms to add more transforms."
    new "Настройте director.transforms, чтобы добавить больше трансформов."
    # renpy/common/00director.rpy:1789
    old "Behind:"
    new "Позади:"
    # renpy/common/00director.rpy:1800
    old "Click to set, right click to add to behind list."
    new "ЛКМ — установить, ПКМ — добавить в список «позади»."
    ...
    new "Вы уверены, что хотите продолжить с последнего места?"
    ...
    new "Вы уверены, что хотите пропустить непрочитанный текст до следующего выбора?"
    # renpy/common/00gui.rpy:459
    old "This save was created on a different device. Maliciously constructed save files can harm your computer. Do you trust this save's creator and everyone who could have changed the file?"
    new "Это сохранение было создано на другом устройстве. Злонамеренно созданные файлы сохранений могут навредить вашему компьютеру. Вы доверяете создателю этого сохранения и всем, кто мог изменить файл?"
    # renpy/common/00gui.rpy:460
    old "Do you trust the device the save was created on? You should only choose yes if you are the device's sole user."
    new "Вы доверяете устройству, на котором было создано сохранение? Выбирайте «Да» только если вы являетесь единственным пользователем этого устройства."
    ...
    new "Эта программа содержит свободное программное обеспечение под несколькими лицензиями, включая MIT License и GNU Lesser General Public License. Полный список программного обеспечения со ссылками на исходный код можно найти {a=https://www.renpy.org/l/license}здесь{/a}."
    ...
    new "пропускать непрочитанный [text]"
    # renpy/common/00preferences.rpy:367
    old "skip unseen text"
    new "пропускать непрочитанный текст"
    ...
    old "self voicing volume drop"
    new "понижение громкости самоозвучивания"
    ...
    new "восстанавливать положение окна"
    ...
    old "mute main"
    new "отключить основную"
    # renpy/common/00preferences.rpy:637
    old "mute music"
    new "отключить музыку"
    ...
    new "Самоозвучивание произнесёт «[renpy.display.tts.last]». Нажмите 'alt+shift+V', чтобы отключить."
    # renpy/common/00preferences.rpy:727
    old "Self-voicing enabled. Press 'v' to disable."
    new "Самоозвучивание включено. Нажмите 'v', чтобы отключить."
    # renpy/common/00speechbubble.rpy:420
    old "Speech Bubble Editor"
    new "Редактор речевых облаков"
    # renpy/common/00speechbubble.rpy:425
    old "(hide)"
    new "(скрыть)"
    # renpy/common/00speechbubble.rpy:436
    old "(clear retained bubbles)"
    new "(очистить сохранённые облака)"
    ...
    new "Время ожидания сервера Ren'Py Sync истекло."
    # renpy/common/00sync.rpy:188
    old "An unknown error occurred while connecting to the Ren'Py Sync server."
    new "Произошла неизвестная ошибка при подключении к серверу Ren'Py Sync."
    # renpy/common/00sync.rpy:204
    old "The Ren'Py Sync server does not have a copy of this sync. The sync ID may be invalid, or it may have timed out."
    new "На сервере Ren'Py Sync нет копии этой синхронизации. Возможно, ID синхронизации недействителен или срок его действия истёк."
    # renpy/common/00sync.rpy:305
    old "Please enter the sync ID you generated.\nNever enter a sync ID you didn't create yourself."
    new "Пожалуйста, введите сгенерированный вами ID синхронизации.\nНикогда не вводите ID, который вы не создавали сами."
    ...
    new "Эта синхронизация принадлежит другой игре."
    ...
    new "Это загрузит ваши сохранения на {a=https://sync.renpy.org}сервер Ren'Py Sync{/a}.\nХотите продолжить?"
    # renpy/common/00sync.rpy:457
    old "Enter Sync ID"
    new "Введите ID синхронизации"
    # renpy/common/00sync.rpy:468
    old "This will contact the {a=https://sync.renpy.org}Ren'Py Sync Server{/a}."
    new "Будет выполнено подключение к {a=https://sync.renpy.org}серверу Ren'Py Sync{/a}."
    ...
    new "Этот проект не поддерживает обновление, либо файл статуса обновления был удалён."
    # renpy/common/00updater.rpy:877
    old "This account does not have permission to perform an update."
    new "У этой учётной записи нет прав на выполнение обновления."
    # renpy/common/00updater.rpy:880
    old "This account does not have permission to write the update log."
    new "У этой учётной записи нет прав на запись журнала обновлений."
    ...
    new "Файл обновления имеет неверную контрольную сумму — возможно, он повреждён."
    ...
    new "Доступна версия [u.version]. Установить её?"
    ...
    new "Произошла ошибка при попытке загрузить данные игры:"
    # renpy/common/00updater.rpy:1997
    old "This game cannot be run until the game data has been downloaded."
    new "Игра не может быть запущена, пока не будут загружены данные игры."
    ...
    new "Драйверы графики могут быть устаревшими или работать некорректно. Это может привести к медленному или неправильному отображению графики."
    ...
    new "Подробную информацию о том, как это исправить, можно найти в {a=[url]}документации{/a}."
    ...
    new "Копирует файл traceback.txt в буфер обмена в формате BBCode для форумов, таких как https://lemmasoft.renai.us/."
    ...
    new "Выполняет откат к предыдущему состоянию, позволяя сохранить игру или выбрать другой вариант."
    ...
    new "Игнорирует исключение, позволяя продолжить. Это часто приводит к дополнительным ошибкам."
    # renpy/common/_errorhandling.rpym:844
    old "Reload"
    new "Перезагрузить"
    # renpy/common/_errorhandling.rpym:846
    old "Reloads the game from disk, saving and restoring game state if possible."
    new "Перезагружает игру с диска, сохраняя и восстанавливая состояние игры, если возможно."
    ...
    new "Не удалось разобрать скрипт."